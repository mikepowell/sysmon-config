...
@powershell (new-object System.Net.WebClient).DownloadFile('https://raw.githubusercontent.com/mikepowell/sysmon-config/master/install/update_sysmon.bat','C:\ProgramData\sysmon\update_sysmon.bat')"
...
SchTasks /Create /RU SYSTEM /RL HIGHEST /SC HOURLY /TN Update_Sysmon_Rules /TR C:\ProgramData\sysmon\update_sysmon.bat /F /ST %tasktime%
timeout /t 10
exit